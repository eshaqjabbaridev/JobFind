...
<html lang="en">
    <head>  
        ...
        <title>آموزشگاه فنی حرفه ای عصر مهارت | دانلود ها</title>
        ...
        <div class="float-left" id="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">دانلود ها</div>
                            <div class="card-body">
                                   ...
                                   <thead>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="#" class="btn btn-primary">آموزش بوت استرپ - حجم 730 مگابایت</a></td>
                                        </tr>
                                    </tbody>
                               </table>
                            </div>
